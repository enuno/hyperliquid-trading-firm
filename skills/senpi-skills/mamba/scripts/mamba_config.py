"""MAMBA Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "mamba-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "mamba-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("MAMBA_WALLET", "")
    strategy_id = os.environ.get("MAMBA_STRATEGY_ID", "")
